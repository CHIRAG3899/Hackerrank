...
#of a binary search tree. Complete the getHeight function provided in your
...
#Each of the  subsequent lines contains an integer,data , denoting the value of
...
class Solution:
    ...
    def getHeight(self,root):
        if root is None:
            ...
            lHeight = myTree.getHeight(root.left)
            rHeight = myTree.getHeight(root.right)
