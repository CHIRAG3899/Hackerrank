...
#in the Input Format section below) and initialize 3 your  variables.
#Use the + operator to perform the following operations:
#Print the sum of i plus your int variable on a new line.
#Print the sum of d plus your double variable to a scale of one
#decimal place on a new line.
#Concatenate s with the string you read as input and print the
...
#following the other on the same line. The string provided in your editor
